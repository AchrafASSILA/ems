<template>
    ...
    <div id="kt_header" class="header header-fixed">
        ...
        <div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
            ...
            >
                <h3 class="font-weight-bold m-0">Mon compte</h3>
                <a
                    href="/profile"
            ...
            <div class="offcanvas-content pr-5 mr-n5">
                ...
                <!--end::Separator-->
                <!--begin::Nav-->
                <div class="navi navi-spacer-x-0 p-0 d-none">
                    <!--begin::Item-->

                    <router-link to="/profile" class="navi-item">
                        <div class="navi-link">
                            ...
                            <div class="navi-text">
                                ...
                                <div class="text-muted">Editer mon profile</div>
                            </div>
                        </div>
                    </router-link>
                    <!--end:Item-->
                    ...
                    >
                        <div class="navi-link">
                            ...
                            <div class="navi-text">
                                <div class="font-weight-bold">Mot de passe</div>
